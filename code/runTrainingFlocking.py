...
for i in range(len(seeds)):
    # os.system("python flockingPHSAseeds.py --numTrain 20000 --numTests 20000 --numSamples 5 --seed "+str(seeds[i])+" --numAgents 4")
    SA[:, i]    = torch.load("flocking4_" + str(seeds[i]) + '_learn_system_phsa_TrainLosses.pth')

print("-----------------------------------")
print("MLP")
print("-----------------------------------")
for i in range(len(seeds)):
    # os.system("python flockingPHMLPseeds.py --numTrain 20000 --numTests 20000 --numSamples 5 --seed " + str(seeds[i]) + " --numAgents 4")
    MLP[:, i]   = torch.load("flocking4_" + str(seeds[i]) + '_learn_system_phmlp_TrainLosses.pth')

print("-----------------------------------")
print("GNN")
print("-----------------------------------")
for i in range(len(seeds)):
    # os.system("python flockingPHGNNseeds.py --numTrain 20000 --numTests 20000 --numSamples 5 --seed " + str(seeds[i]) + " --numAgents 4")
    GNN[:, i]   = torch.load("flocking4_" + str(seeds[i]) + '_learn_system_phgnn_TrainLosses.pth')

print("-----------------------------------")
print("GNNSA")
print("-----------------------------------")
for i in range(len(seeds)):
    # os.system("python flockingPHGNNSAseeds.py --numTrain 20000 --numTests 20000 --numSamples 5 --seed " + str(seeds[i]) + " --numAgents 4")
    GNNSA[:, i] = torch.load("flocking4_" + str(seeds[i]) + '_learn_system_phgnnsa_TrainLosses.pth')
