...
for i in range(len(seeds)):
    os.system("python navigationTvPHMLPseeds.py --numTrain 20000 --numTests 20000 --numSamples 5 --seed " + str(seeds[i]) + " --numAgents 4")
    MLP[:, i]   = torch.load("navigationTv4_" + str(seeds[i]) + '_learn_system_phmlp_TrainLosses.pth')

print("-----------------------------------")
print("GNN")
print("-----------------------------------")
for i in range(len(seeds)):
    os.system("python navigationTvPHGNNseeds.py --numTrain 20000 --numTests 20000 --numSamples 5 --seed " + str(seeds[i]) + " --numAgents 4")
    GNN[:, i]   = torch.load("navigationTv4_" + str(seeds[i]) + '_learn_system_phgnn_TrainLosses.pth')

print("-----------------------------------")
print("GNNSA")
print("-----------------------------------")
for i in range(len(seeds)):
    os.system("python navigationTvPHGNNSAseeds.py --numTrain 20000 --numTests 20000 --numSamples 5 --seed " + str(seeds[i]) + " --numAgents 4")
    GNNSA[:, i] = torch.load("navigationTv4_" + str(seeds[i]) + '_learn_system_phgnnsa_TrainLosses.pth')

print("-----------------------------------")
print("SA")
print("-----------------------------------")
for i in range(len(seeds)):
    os.system("python navigationTvPHSAseeds.py --numTrain 20000 --numTests 20000 --numSamples 5 --seed "+str(seeds[i])+" --numAgents 4")
    SA[:, i]    = torch.load("navigationTv4_" + str(seeds[i]) + '_learn_system_phsa_TrainLosses.pth')
