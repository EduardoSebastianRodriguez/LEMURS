...
step_size  = 0.04
time       = 10.0
trajectory = np.load('FS_trajectory_learned'+str(na_train)+str(na_tests)+'_LEMURS.npy')

# Define the meta data for the movie
FFMpegWriter = manimation.writers['ffmpeg']
metadata = dict(title='Movie Fixed Swapping', artist='Matplotlib', comment='fixed swapping animation')
...
with writer.saving(fig, "FS_animation"+str(na_train)+str(na_tests)+".mp4", 300):
