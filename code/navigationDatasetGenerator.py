...
from navigationFunctions import realNavigation, get_cmap, generate_leader, generate_agents
...
def main(numTrain=1000, numTests=200, numSamples=5, seed=42, numAgents=4):
    ...
    # Store data
    torch.save(inputsTrain,   'navigation'+str(numAgents)+'_inputsTrain_'+str(numTrain)+str(numTests)+str(numSamples)+str(seed)+'_.pth')
    torch.save(targetTrain_2, 'navigation'+str(numAgents)+'_target2Train_'+str(numTrain)+str(numTests)+str(numSamples)+str(seed)+'_.pth')
    torch.save(inputsTests,   'navigation'+str(numAgents)+'_inputsTests_'+str(numTrain)+str(numTests)+str(numSamples)+str(seed)+'_.pth')
    torch.save(targetTests_2, 'navigation'+str(numAgents)+'_target2Tests_'+str(numTrain)+str(numTests)+str(numSamples)+str(seed)+'_.pth')
